class PlanesController < ApplicationController
  ...
  def new
    @plane = Plane.new
    @plane.seat_configurations.build
  end
  ...
  private
    ...
    def plane_params
      params.require(:plane).permit(:name, :plane_number,
        seat_configurations_attributes: [:category_id, :seats_in_row, :number_of_rows, :base_price, :_destroy]
      )
    end
end

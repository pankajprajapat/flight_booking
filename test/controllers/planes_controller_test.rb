...
class PlanesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plane" do
    assert_difference('Plane.count') do
      post planes_url, params: { plane: { name: @plane.name, plane_number: @plane.plane_number } }
    end
  ...
  test "should update plane" do
    patch plane_url(@plane), params: { plane: { name: @plane.name, plane_number: @plane.plane_number } }
